...
interface AirportSectionHeaderProps {
  seo?: SEOFields;
  heading?: string;
  subtitle1?: string;
  subtitle2?: string;
...
export default function AirportSectionHeader({
  seo,
  heading = "Flight Information Display Systems",
  subtitle1 = "Sumith's Flight information display systems make up the heart of any airport, operating in crucial functions for both control rooms and passenger information.",
  subtitle2 = "",
  image,
}: AirportSectionHeaderProps) {
  return (
    <>
      <Head>
