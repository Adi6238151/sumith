...
const slides = [
  {
    label: "Sumith's",
    title: "Transit Bus Solution",
    description: "Sumith's bus solution provides a one-stop solution for passengers, drivers, and operators, making sure all parties are satisfied.",
    image: "/images/transit-bus-solution.jpg"
  },
  {
    label: "Sumith's",
    title: "School Bus Solution",
    description: "Sumith's School bus solution ensures passenger safety and experience on a daily basis.",
    image: "/images/bus-solution.jpg"
  },
  {
    label: "Sumith's",
    title: "Truck Solution",
    description: "Sumith's truck solution focuses on improving customer experience, lowering management costs, and optimizing driver routes.",
    image: "/images/truck-solution.jpg"
  }
]
...
export default function SolutionCarousel() {
  ...
  function jumpTo(idx) { setActive(idx) }

  // Auto-advance on hover (for left arrow)
  ...
  // Auto-advance on hover (for dots, activates that dot and cycles forward)
  function startDotHover(idx) {
    stopHover()
    setActive(idx)
    hoverTimer.current = setInterval(() => {
