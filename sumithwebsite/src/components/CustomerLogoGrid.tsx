...
const oems = [
  { name: "Olectra", logo: "/logos/olectra.png" },
  { name: "PMI", logo: "/logos/pmi.png" },
  { name: "TATA", logo: "/logos/tata.png" },
  { name: "Marcopolo", logo: "/logos/marcopolo.png" },
]

const other = [
  { name: "Global Group", logo: "/logos/globalgroup.png" },
  { name: "ANTONY", logo: "/logos/antony.png" },
  { name: "ACGL", logo: "/logos/acgl.png" },
  { name: "Blackbuck", logo: "/logos/blackbuck.png" },
  { name: "Amnex", logo: "/logos/amnex.png" },
  { name: "KPIT", logo: "/logos/kpit.png" },
  { name: "CMC", logo: "/logos/cmc.png" },
  { name: "Rosmerta", logo: "/logos/rosmerta.png" },
  { name: "UNO MINDA", logo: "/logos/unominda.png" },
  { name: "Rex Coaches", logo: "/logos/rexcoaches.png" },
  { name: "Shree Cement", logo: "/logos/shreecement.png" },
  { name: "APSRTC", logo: "/logos/apsrtc.png" },
  { name: "NWKSRTC", logo: "/logos/nwksrtc.png" },
  { name: "TGSRTC", logo: "/logos/tgsrtc.png" },
  { name: "PMPML", logo: "/logos/pmpml.png" },
]

export default function CustomerLogoGrid() {
  const [fallback, setFallback] = useState({})

  const handleError = (idx, isOem) => {
